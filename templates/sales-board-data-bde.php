...
function get_new_recurring_target($data, $country = 'All', $currency = 'AUD', $number = false)
{
    ...
    foreach ($data as $row) {
        if ($country) {
            ...
            if ($row['AM/Sales/CM'] == 'Ads Team') {
                $total = $total + convert_to_currency($row['New Recurring Target'], 'TH', $currency);
            } else {
...
function get_new_recurring_collected($data, $country = 'All', $currency = 'AUD', $number = false)
{
    ...
    foreach ($data as $row) {
        if ($country) {
            ...
            if ($row['AM/Sales/CM'] == 'Ads Team') {
                $total = $total + convert_to_currency($row['New Recurring Collected'], 'TH', $currency);
            } else {
...
{
    if ($number) {
        if(get_new_recurring_target($data, $country, $currency, true) == 0){
            return 0;
        }
...
function get_monthly_recurring_target($data, $country = 'All', $currency = 'AUD', $number = false)
{
    ...
    foreach ($data as $row) {
        if ($country) {
            ...
            if ($row['AM/Sales/CM'] == 'Ads Team') {
                $total = $total + convert_to_currency($row['Monthly Recurring Target'], 'TH', $currency);
            } else {
...
function get_monthly_recurring_collected($data, $country = 'All', $currency = 'AUD', $number = false)
{
    ...
    foreach ($data as $row) {
        if ($country) {
            ...
            if ($row['AM/Sales/CM'] == 'Ads Team') {
                $total = $total + convert_to_currency($row['Monthly Recurring Collected'], 'TH', $currency);
            } else {
...
{
    if ($number) {
        if(get_monthly_recurring_target($data, $country, $currency, true) == 0){
            return 0;
        }
...
function get_singles($data, $country = 'All', $currency = 'AUD', $number = false)
{
    ...
    foreach ($data as $row) {
        if ($country) {
            ...
            if ($row['AM/Sales/CM'] == 'Ads Team') {
                $total = $total + convert_to_currency($row['Singles'], 'TH', $currency);
            } else {
...
function get_total_in($data, $country = 'All', $currency = 'AUD', $number = false)
{
    ...
    foreach ($data as $row) {
        if ($country) {
            ...
            if ($row['AM/Sales/CM'] == 'Ads Team') {
                $total = $total + convert_to_currency($row['Total Money in'], 'TH', $currency);
            } else {
